...
public class PersonRepository extends StargateDocumentRepository<Person> implements InitializingBean {
     ...
     *      client for Astra
     */
    public PersonRepository(AstraClient astraClient, @Value("${wu.namespace}") String namespace) {
        super(astraClient.apiStargateDocument().namespace(namespace), Person.class);
    }
